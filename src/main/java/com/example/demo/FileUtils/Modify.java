        ...
        try {
            ...
            while (true) {
                ...
                if (str.contains(target)) {
                    String finalStr = replaceCode(str);
//                    String finalStr = replaceCONVERT(str);
    ...
    /**
     * 替换sqlserver的convert函数
     * @param str
     * @return
     */
    public String replaceCONVERT(String str){
        int old_start = str.indexOf(target);
        int old_end = str.indexOf("126),") + 5;
        String oldStr = str.substring(old_start,old_end);
        String old = oldStr.replaceAll("\\(","\\\\(").replaceAll("\\)","\\\\)");
        int new_start = str.indexOf("DATETIME") + 9;
        int new_end  = str.indexOf("126),") ;
        String newStr = str.substring(new_start,new_end);
        String finalStr = str.replaceAll(old,newStr);
        return finalStr;
    }

    public String replaceCode(String str){
        String finalStr = str.replaceAll(target,newContent);
        return finalStr;
    }
    ...
    public static void main(String[] args) {
        ...
        // new Modify("E:\\k2\\sql\\SQLServer\\sql_mysql", "CONVERT", "");
        new Modify("E:\\k2\\sql\\SQLServer\\temp", "segment_type_child", "sg_type_child");
    }
}
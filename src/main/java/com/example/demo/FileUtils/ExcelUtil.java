...
public class ExcelUtil {
    ...
    public static int  LogInfo(String parentId,List<ExcelObject> list,BufferedWriter writer) throws IOException {
        for(int i =0 ;i<list.size();i++){
            ...
            System.out.println("num2:" + num +"--> name:" + list.get(i).getName()+"--->"+list.get(i).getLevel());
            list.get(i).setParentId(parentId);
//            writer.write("insert into segment (id,segment_id,name,parent_id) values ('"+num+"','"+list.get(i).getName()+"','"+list.get(i).getType()+"','"+parentId+"');" + "\n");
//            writer.write("insert into device (id,device_no,name,type,remark,is_root) values ('"+num+"','6_0_0_"+num+"','"+list.get(i).getName()+"','"+list.get(i).getType()+"','"+list.get(i).getMark()+"',0);" + "\n");
